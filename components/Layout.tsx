...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    // Outer Container: Centers the app on large screens (Desktop/Tablet)
    <div className="min-h-screen w-full bg-[#E5E0D8] flex justify-center items-start">
      
      {/* Mobile App Container: Constrained width, full height */}
      <div className="w-full max-w-md bg-slate-50 min-h-screen flex flex-col relative shadow-2xl overflow-hidden ring-1 ring-slate-900/5">
